...
export function TopBar({ projectName, workspace, locale, inspectorOpen, mediaOpen, exportAvailable, t, onWorkspaceChange, onLocaleChange, onInspectorToggle, onMediaToggle }: TopBarProps) {
  ...
  return (
    <header className="topbar">
      ...
      <div className="top-actions">
        ...
        <span className="save-status"><i aria-hidden="true" />{t("top.saved")}</span>
