...
function TranscriptionWorkspace({ project, activeSourceId, playheadMs, playing, t, onPlayingChange }: WorkspaceStageProps) {
    ...
    <div className="specialized-workspace transcript-workspace" data-testid="workspace-transcription">
      <section className="dominant-list-panel">
        ...
        <div className="transcript-segments">
          ...
          {!transcript && <p className="workspace-empty-state" role="status">{t("transcription.emptyForSource")}</p>}
        </div>
...
function CompositionWorkspace({ project, playheadMs, playing, t, onPlayingChange }: WorkspaceStageProps) {
...
function CaptionsWorkspace({ project, selectedProjectItemId, playheadMs, playing, t, onProjectSelect, onPlayingChange }: WorkspaceStageProps) {
  return (
...
function AudioWorkspace({ project, playheadMs, playing, t, onPlayingChange }: WorkspaceStageProps) {
