...
“Headless” define a fronteira arquitetural, não o processo final: biblioteca + launcher, processo local dedicado ou outra topologia ficam para decisão posterior. Ver ADR 0021.
