...
**D14-T4 [V1] Catálogo EDVID de legendas**  
Ação: confira Karaokê, Empilhado, Disperso, Simples, Serifada, Clássica e Nenhum.  
Esperado: todos os estilos V1 entregues funcionam; nenhuma personalização pós-V1 é necessária para considerar o catálogo base conforme.  
Responder: PASS/PARTIAL/FAIL.
...
**D17-T1 [V1] Nível 1 — layout conhecido**  
Ação: legenda em composição simples com safe areas, título/layout conhecidos e sem risco de sujeito.  
Esperado: posição correta sem acionar tracking/matting desnecessário.  
Responder: PASS/PARTIAL/FAIL.

**D17-T2 [V1] Escalada N1 → N2**  
Ação: coloque sujeito na região candidata da legenda.  
Esperado: Planner usa evidência leve de face/pessoa quando necessária e resolve sem matting completo se suficiente.  
Responder: PASS/PARTIAL/FAIL.

**D17-T3 [V1] Escalada N2 → N3**  
Ação: fixture com sujeito/gestos/movimento em que região aproximada seja ambígua.  
Esperado: máscaras apenas em frames representativos produzem occupancy/safe-zones; não há matte temporal completo se não for necessário.  
Responder: PASS/PARTIAL/FAIL.

**D17-T4 [ADV] Nível 4 behind-subject**  
Ação: quando matting temporal estiver disponível, usar HeroEmphasis atrás do sujeito.  
Esperado: oclusão temporal coerente; N4 é usado por necessidade do efeito, não como default da legenda comum.  
Responder: APROVADO/REPROVADO/BLOCKED.

**D17-T5 [V1] Tela cheia ↔ split por intervalo**  
Ação: use legenda que atravessa mudança de layout.  
Esperado: posição se adapta e depois retorna sem alterar texto/sync ou manter override obsoleto.  
Responder: APROVADO/REPROVADO.

**D17-T6 [V1] Safe areas e overlays**  
Ação: use headline/B-roll/split/platform UI zones na região preferida.  
Esperado: Planner evita regiões proibidas/conflitantes antes de buscar análise visual mais cara.  
Responder: PASS/PARTIAL/FAIL.

**D17-T7 [V1] Posição fixada pelo usuário**  
Ação: fixe posição em trecho e provoque uma alteração visual próxima.  
Esperado: escolha explícita não é sobrescrita; conflito real é informado.  
Responder: PASS/PARTIAL/FAIL.

**D17-T8 [V1] Luminância/legibilidade**  
Ação: posicione legenda sobre fundo muito claro/escuro.  
Esperado: CEVRA valida legibilidade e usa variante/efeito já suportado ou muda de zona; Brand Kit/preset não é substituído por paleta automática.  
Responder: APROVADO/REPROVADO.

**D17-T9 [V1/AUTO] Caption QA — overflow/clipping**  
Ação técnica: produzir casos de texto grande, borda e safe-area violada.  
Esperado: QA sinaliza corretamente sem alterar o projeto por conta própria.  
Responder: PASS/PARTIAL/FAIL.

**D17-T10 [V1/AUTO] Caption QA — sujeito/overlay**  
Ação técnica: gerar conflito com sujeito/elemento conhecido.  
Esperado: PASS/WARN/FAIL/UNKNOWN coerente com a evidência disponível; ausência de máscara não vira falso PASS.  
Responder: PASS/PARTIAL/FAIL.

**D17-T11 [V1/AUTO+MANUAL] Preview amostrado**  
Ação: gerar snapshots em mudança de layout e trechos sinalizados.  
Esperado: snapshots representam adequadamente o composite final; Product Owner recebe somente casos que precisam julgamento visual.  
Responder: APROVADO/REPROVADO quando manual.

**D17-T12 [BENCH/AUTO] Custo progressivo**  
Ação técnica: medir N1/N2/N3 e, quando disponível, N4 em fixtures equivalentes.  
Esperado: evidência de que análise mais pesada não roda sem necessidade e custos por nível ficam registrados.  
Responder: PASS/PARTIAL/FAIL.


## D18 — Personalização adicional de legendas — pós‑V1

**D18-T1 [ADV] Reavaliação de demanda**  
Ação: após V1, revisar uso real/Brand Kit e demanda por cor/tamanho/fontes/efeitos adicionais.  
Esperado: somente controles com benefício proporcional avançam; não assumir implementação por existir parâmetro upstream.  
Responder: APROVADO/REPROVADO/BLOCKED.

**D18-T2 [ADV] Personalização sem alterar identidade do estilo**  
Ação: quando uma personalização for implementada, alterar parâmetro suportado.  
Esperado: texto/sync/animação-base e correções permanecem; preview/export equivalentes.  
Responder: APROVADO/REPROVADO/BLOCKED.

**D18-T3 [ADV] Restaurar padrão**  
Ação: personalize e restaure.  
Esperado: aparência volta ao padrão sem apagar texto/montagem.  
Responder: PASS/PARTIAL/FAIL/BLOCKED.

**D18-T4 [ADV] Controle não suportado**  
Ação: procurar personalização não implementada.  
Esperado: UI não oferece controle enganoso nem cria reforma automática.  
Responder: PASS/PARTIAL/FAIL/BLOCKED.
...
**D23-T9 [ADV] HeroEmphasis como capability independente**  
Ação: quando disponível, usar HeroEmphasis sobre um dos estilos EDVID.  
Esperado: estilo base permanece o mesmo; efeito é componente separado, pode ser desligado e, para behind-subject, exige SubjectMaskProvider temporal adequado.  
Responder: APROVADO/REPROVADO/BLOCKED.

**D23-T10 [INT/AUTO] SubjectMaskProvider desacoplado**  
Ação técnica: trocar provider de máscara compatível em fixture.  
Esperado: Caption Planner/behind-subject consomem contrato comum sem acoplamento ao modelo concreto; projeto canônico não muda de identidade.  
Responder: PASS/PARTIAL/FAIL.
